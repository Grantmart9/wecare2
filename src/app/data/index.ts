// data/index.ts
export interface EmailDataWithEmail {
  id: number;
  title: string;
  text: string;
  email: string;
...
export interface PhoneDataWithPhone {
  id: number;
  title: string;
  text: string;
  phone: string;
...
export const emailData: EmailDataWithEmail[] = [
  {
    id: 1,
...
export const phoneData: PhoneDataWithPhone[] = [
  {
    id: 1,
